...
| Do the tests pass offline? | `pytest -m "not network and not ocr and not llm" -q` | 1747 passed, 40 skipped, none failed, measured in a clean clone of `9682b81` with every non-loopback socket refused |
...
fresh clone of commit `9682b81` with every non-loopback socket refused: 16 of 16 steps
...
The repository is 59.75 MB across 485 tracked files as of commit `636986b`,
