...
| Do the tests pass offline? | `pytest -m "not network and not ocr and not llm" -q` | 1735 passed, 40 skipped, none failed, measured in a clean clone of `a1815f2` with every non-loopback socket refused |
...
fresh clone of commit `a1815f2` with every non-loopback socket refused: 16 of 16 steps
...
The repository is 59.72 MB across 484 tracked files as of commit `b9a6cd0`,
