...
apps/
  web/                                        the console, Next.js, statically exported to Vercel
    ...
    public/   (82 files)
    tests/   (13 files)
artifacts/   (70 files)                       the receipts every published figure is read out of
...
scripts/   (73 files)                         one runnable step each, and the gate that ties them together
tests/   (93 files)                           the offline suite, including the checks that read the receipts back
```
