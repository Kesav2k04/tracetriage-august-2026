...
**[3-minute film](https://youtu.be/uQlwfef5Hz4)** &nbsp;·&nbsp;
...
| [`scripts/`](scripts) | 74 files. One runnable step each, and the gate that ties them together |
...
| | |
| --- | --- |
| [`apps/web/`](apps/web) | 162 files. The console, Next.js, statically exported to Vercel |
...
| | |
| --- | --- |
| [`.bob/`](.bob) | 4 files. What IBM Bob was pointed at |
