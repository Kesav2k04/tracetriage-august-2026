...
| `REPO_WEIGHT.json` | REPO_WEIGHT | 0.1.0 | none | 4,272 | `8fe83c583e2c8019` | `scripts/audit_release.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `SECRET_SCAN.json` | SECRET_SCAN | 0.1.0 | none | 1,214 | `5de251ad5e99f51f` | `scripts/audit_release.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_reference_sync.py`, `test_release_audit.py` |
| `SIGNOFF_RECEIPT.json` | SIGNOFF_RECEIPT | 0.1.0 | none | 3,643 | `35448f233737a513` | `scripts/gate.py`, `scripts/signoff.py` | `test_signoff.py` |
