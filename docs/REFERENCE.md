...
| `GATE_POWER_RECEIPT.json` | GATE_POWER_RECEIPT | 1 | none | 10,800 | `4c102864f1cbf706` | `scripts/build_console_data.py`, `scripts/run_gate_power.py`, `scripts/sync_for_judges.py`, `scripts/sync_readme_results.py` | `test_gate_power.py` |
