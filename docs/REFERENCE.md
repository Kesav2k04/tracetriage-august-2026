...
At this commit: 44 JSON artifacts, 8 contracts, 62 scripts, 29 package modules and 1516 test functions across 87 test modules. Parametrised functions collect as more than one case, so pytest's collected count is higher.
...
| `ATTRIBUTION_AUDIT.json` | ATTRIBUTION_AUDIT | 0.1.0 | none | 89,806 | `ab2eb8351c312797` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `FILM_RECEIPT.json` | FILM_RECEIPT | 1 | none | 6,475 | `ce715c1cca09a44e` | `scripts/check_receipt_digests.py`, `scripts/sync_for_judges.py` | `test_film_receipt.py`, `test_prose_drift.py` |
...
| `LIVE_TAKE.json` | artifacts/LIVE_TAKE.json | 1 | none | 7,765 | `c77a0ef0ed94ff95` | `scripts/check_receipt_digests.py`, `scripts/record_live_take.py` | `test_live_take.py`, `test_receipt_digests.py` |
...
| `NARRATION_RECEIPT.json` | none declared | n/a | none | 19,117 | `c451750434fd628d` | `scripts/cast_narration_voice.py`, `scripts/render_narration.py`, `scripts/sync_for_judges.py` | `test_receipt_digests.py` |
...
| `REPO_WEIGHT.json` | REPO_WEIGHT | 0.1.0 | none | 5,138 | `27cb76eb5b482983` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `SECRET_SCAN.json` | SECRET_SCAN | 0.1.0 | none | 1,053 | `13c2776a7d58ef27` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_reference_sync.py`, `test_release_audit.py` |
...
| `scripts/record_live_take.py` | Record what the deployed console returned in one filmed take, and what the tree holds. |
...
| `tests/test_live_take.py` | 6 | The filmed take is what the film says it is. |
| `tests/test_mcp_server.py` | 40 | The evidence server, driven through its own transport (unit E3). |
| `tests/test_media_faststart.py` | 2 | Every video this repository publishes can start before it has finished downloading. |
