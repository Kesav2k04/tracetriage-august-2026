...
| `SIGNOFF_RECEIPT.json` | SIGNOFF_RECEIPT | 0.1.0 | none | 3,791 | `98a7f5b035129875` | `scripts/build_console_data.py`, `scripts/gate.py`, `scripts/signoff.py` | `test_signoff.py` |
