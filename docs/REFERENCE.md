...
At this commit: 41 JSON artifacts, 8 contracts, 59 scripts, 29 package modules and 1460 test functions across 81 test modules. Parametrised functions collect as more than one case, so pytest's collected count is higher.
...
| `ATTRIBUTION_AUDIT.json` | ATTRIBUTION_AUDIT | 0.1.0 | none | 85,738 | `85728aaefafb7186` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `GATE_POWER_RECEIPT.json` | GATE_POWER_RECEIPT | 1 | none | 11,321 | `21868767aa13d6c0` | `scripts/build_console_data.py`, `scripts/run_gate_power.py`, `scripts/sync_for_judges.py`, `scripts/sync_readme_results.py` | `test_gate_power.py` |
...
| `REPO_WEIGHT.json` | REPO_WEIGHT | 0.1.0 | none | 5,142 | `5f0dd39137879ae2` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `SECRET_SCAN.json` | SECRET_SCAN | 0.1.0 | none | 1,053 | `dce0adac89264c83` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_reference_sync.py`, `test_release_audit.py` |
| `SIGNOFF_RECEIPT.json` | SIGNOFF_RECEIPT | 0.1.0 | none | 3,791 | `fe5708190661095b` | `scripts/build_console_data.py`, `scripts/check_artifact_freshness.py`, `scripts/gate.py`, `scripts/signoff.py` | `test_freshness_outcomes.py`, `test_signoff.py` |
...
| `tests/test_prose_drift.py` | 7 | Judge-facing prose, checked against the receipts it quotes. |
