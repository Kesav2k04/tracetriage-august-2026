...
| `ATTRIBUTION_AUDIT.json` | ATTRIBUTION_AUDIT | 0.1.0 | none | 88,577 | `4e3566fdf2d69b0e` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `FILM_RECEIPT.json` | FILM_RECEIPT | 1 | none | 6,130 | `a8db60958f2aa658` | `scripts/check_receipt_digests.py`, `scripts/sync_for_judges.py` | `test_film_receipt.py`, `test_prose_drift.py` |
...
| `NARRATION_RECEIPT.json` | none declared | n/a | none | 17,928 | `360eb66fc54b9bbc` | `scripts/cast_narration_voice.py`, `scripts/render_narration.py`, `scripts/sync_for_judges.py` | `test_receipt_digests.py` |
...
| `REPO_WEIGHT.json` | REPO_WEIGHT | 0.1.0 | none | 5,129 | `558cb54b6a39106c` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_release_audit.py` |
...
| `SECRET_SCAN.json` | SECRET_SCAN | 0.1.0 | none | 1,053 | `4b20aec257866020` | `scripts/audit_release.py`, `scripts/build_console_data.py`, `scripts/signoff.py`, `scripts/sync_for_judges.py` | `test_reference_sync.py`, `test_release_audit.py` |
