...
| `FILM_RECEIPT.json` | FILM_RECEIPT | 1 | none | 6,475 | `6bbb90aed6df0779` | `scripts/check_receipt_digests.py`, `scripts/sync_for_judges.py` | `test_film_receipt.py`, `test_prose_drift.py` |
